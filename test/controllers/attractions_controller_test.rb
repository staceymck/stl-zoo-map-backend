...
class AttractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post attractions_url, params: { attraction: { name: @attraction.name, zone_id: @attraction.zone_id } }, as: :json
    end
  ...
  test "should update attraction" do
    patch attraction_url(@attraction), params: { attraction: { name: @attraction.name, zone_id: @attraction.zone_id } }, as: :json
    assert_response 200
  end
