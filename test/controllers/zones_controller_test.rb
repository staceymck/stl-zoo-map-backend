...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { description: @zone.description, name: @zone.name } }, as: :json
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { description: @zone.description, name: @zone.name } }, as: :json
    assert_response 200
  end
